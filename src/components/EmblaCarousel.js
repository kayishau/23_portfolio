          ...
          {slides.map((index) => (
            ...
            >
              ...
              <div className="flex flex-col items-center gap-1 tablet:gap-2 opacity-75 hover:opacity-100 border-2 border-projectBorder hover:border-primary">
                ...
                <div className="flex flex-col w-full items-center gap-1 tablet:gap-2 md:gap-3 lg:gap-2 opacity-75 border bg-gradient-to-r from-white to-slate-300 p-1 tablet:p-2">
