  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-full px-4 lg:mr-10 lg:w-1/2 flex flex-col justify-center items-center">
          <div>
          ...
          <p className="text-sm xl:text-base my-2 md:my-4 md:pr-8 font-cg text-center lg:text-left">
