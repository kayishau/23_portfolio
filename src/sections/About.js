    ...
    <>
      ...
      >
        ...
        <div className="w-full px-4 lg:px-0 lg:mr-10 lg:w-1/2 flex flex-col justify-center items-center">
          ...
          <h2 className="text-md lg:text-lg xl:text-xl font-cg italic font-bold uppercase text-center text-primary/75">
           An introverted extrovert with too many passions to count 
          </h2>
          <p className="text-xs tablet:text-sm lg:text-base my-2 xl:my-4 md:pr-8 font-cg text-center lg:text-justify">
